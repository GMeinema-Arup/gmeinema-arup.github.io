...
<section class="about reveal">
  ...
  <ul>
    <li>
      <strong>M.Sc. Structural Engineering</strong> @ Delft University of Technology (September 2022–March 2025)
      <br>Extracurricular: Bridge Design (Faculty of Architecture)
    </li>
    <li>
      <strong>B.Sc. Civil Engineering</strong> @ Delft University of Technology (September 2017–July 2021)
      <br>Minor: House of the Future (Faculty of Architecture)
    </li>
    <li>
      <strong>Stedelijk Gymnasium</strong> @ Nijmegen (September 2011–July 2017)
    </li>
  </ul>
  ...
  <ul>
    <li>
      <strong>Bridge Engineer</strong> @ Arup (July 2025–Present)
      <ul>
        <li>Analysis, assessment and strengthening of bridge structures.</li>
      </ul>
    </li>

    <li>
      <strong>Graduate Intern</strong> @ Arup (September 2024–February 2025)
      <ul>
        <li>Master thesis research on strengthening prestressed concrete T-beams.</li>
      </ul>
    </li>
    ...
    <li>
      ...
      <ul>
        <li>Developed communication, organisation and stakeholder management skills.</li>
      </ul>
    </li>
  </ul>
  ...
  <ul>
    <li>
      <strong>Trainee</strong> @ STEORR (Autumn 2023)
      <ul>
        <li>Participated in multidisciplinary research on flood protection in Suriname.</li>
      </ul>
    </li>
  </ul>
